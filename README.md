...
4. Verificar que PostgreSQL esté corriendo de manera local
5. Ejecutar el comando "pnpm exec prisma migrate dev" para crear las tablas definidas dentro de schema.prisma en la base de datos
6. Abrir una terminal y ejecutar el comando "pnpm server:dev" esto ejecuta el backend
7. Abrir una segunda terminal y ejecutar el comando "pnpm dev" esto ejecuta el frontend y proporciona el link a la página web en localhost
