...
export type OrderWhereInput = {
    ...
    products?: Prisma.StringNullableListFilter<"Order">;
...
export type OrderCreateInput = {
    uid: string;
    id: number;
    products?: Prisma.OrderCreateproductsInput | string[];
    total: number;
...
export type OrderUpdateInput = {
    ...
    products?: Prisma.OrderUpdateproductsInput | string[];
...
export interface OrderDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
     *
     * // Create many Orders and only return the `uid`
     * const orderWithUidOnly = await prisma.order.createManyAndReturn({
     *   select: { uid: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     *
     * // Update zero or more Orders and only return the `uid`
     * const orderWithUidOnly = await prisma.order.updateManyAndReturn({
     *   select: { uid: true },
     *   where: {
     *     // ... provide filter here
     *   },
